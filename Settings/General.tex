...
\AddTitlePageDataLine{Vorgelegt von}{
	\@author \newline
	11. Fachsemester \newline
	\href{mailto:luis.meyer@student.reutlingen-university.de}{luis.meyer@student.reutlingen-university.de}
}
\makeatother
...
% Format: DD.MM.YYYY
\AddTitlePageDataLine{Vorgelegt am}{05.11.2025}
...
\AddTitlePageDataLine{Dozent}{Prof. Dr. Sven Steddin}
...
% ------------------------------------------------------------------------------
\newcommand{\modulename}{METI6.3 – SAT – WiSe 2025/2026}
